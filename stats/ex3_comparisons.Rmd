...
plot5 <- data.frame(noisy.model$Experiment,pd$mean[pd$Model=="Data"],noisy.model$mean,rep("Data vs Noisy Model",8))
names(plot5) = c("Experiment","Data","Model","Comp")
