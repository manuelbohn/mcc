...
var model = function(){
   ...
   var ageSpecificParams =  _.filter(modelParams, {age_bin: conditionInfo.age_bin})

    display(JSON.stringify(ageSpecificParams))

    var speakerOptimality = ageSpecificParams.so_map
    
    var diff_priorReg = ageSpecificParams.diff_priorReg_map
