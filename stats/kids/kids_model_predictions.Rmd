...
```{r}
params_by_age<- readRDS("../saves/child_model_param.rds")
...
ggplot(models)+
  ...
  geom_smooth(data = p_data, aes(x = age_num, y = correct_inf), col = "black", method = "loess", span = 1, se = T,  alpha = .5, size = .4)+
  #geom_hline(yintercept = 0.5, lty=2)+
  labs(y="proportion more informative")+
  ylim(-0.05,1.05)+
  facet_grid(Speaker~Alignment)+
