...
pref_data <- read_csv(file="../data/kids_pref_data.csv")%>%
  ...
  mutate(age_bin = factor(age),
         ...
         condition = ifelse(change == F, "same_speaker", "different_speaker"),
         agent = ifelse( change == F, agent, altAgent),
         minage = min(age_num))%>%
...
var model  = function(){
 ...
 var noisyRsaPredictions_same_incong = expectation(addNoise(rsaPredictions_same_incong, noise))
    ...
    // diff_speaker_params, same_speaker_params, 
      ...
      same_priorReg,
      speakerOptimality,
      noisyRsaPredictions_diff_cong,
      noisyRsaPredictions_diff_incong,
      noisyRsaPredictions_same_cong,
      noisyRsaPredictions_same_incong,
      age_bin,
      so_slope,
      so_int,
      noise
...
## importing data
d <- read_csv(file="../data/kids_ex3_data.csv")
