...
Model testing for interaction between change and condition. No interaction between change and condition, and no effect of condition suggesting that speaker change manipualtion is similar in novelty and preference.
```{r}
## model
library(lme4)
...
lm <- glmer(correct ~ change * condition + trial +
              (change + trial|id) + (1|choiceAgent), 
            data = data_cg, family = binomial, control=glmerControl(optimizer="bobyqa",
