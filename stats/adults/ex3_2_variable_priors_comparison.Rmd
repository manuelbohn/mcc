...
dat <- bind_rows(read_csv(file="../data/ex3.2.novel.strong.data.csv"),
               read_csv(file="../data/ex3.2.novel.medium.data.csv"),
               read_csv(file="../data/ex3.2.novel.weak.data.csv"),
               read_csv(file="../data/ex3.2.pref.strong.data.csv"),
               read_csv(file="../data/ex3.2.pref.medium.data.csv")
               ) %>%
...
m.data.strong <- data %>%
  filter(Prior == "Strong") %>%
  mutate(item = ifelse( change == "same", agent, altAgent))
