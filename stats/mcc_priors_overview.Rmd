...
```{r data}
d1 <- read_csv(file="novel.weak.data2.csv") %>%
...
d2 <- read_csv(file="novel.weak.data.csv") %>%
  mutate(trial_type = ifelse(trial == "train", "train", "test"),
         strength = "1_weak")

d3 <- read_csv(file="novel.data.csv") %>%
  mutate(trial_type = ifelse(trial == "train", "train", "test"),
         strength = "3_strong")

d4 <-read_csv(file="pref.data.csv") %>%
  mutate(trial_type = ifelse(trial == "train", "train", "test"),
         strength = "3_strong")
...
d6 <-read_csv(file="pref.weak.data2.csv") %>%
  mutate(trial_type = ifelse(trial == "train", "train", "test"),
         strength = "1_weak")
