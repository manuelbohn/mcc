...
/*            setTimeout(function() {     
 ...
 train: function() {
   ...
   if (experiment.trial[0] == "train1"){
    ...
    if (experiment.agentOrient[0][0] == "point" || experiment.agentOrient[0][0] == "point") {
        experiment.choice();
        return;
    };  
...
// commenting on objects (or their absence) on the tables depending on condition   
 ...
 if (experiment.agentOrient[0][0] == "point" && experiment.cond[0][2] == "right"){
          pause("next",2300);    
          showAgent(agents[0],"point_r1")
     ...
     } else if (experiment.agentOrient[0][0] == "point" && experiment.cond[0][2] == "left") {
         pause("next",2300);    
         showAgent(agents[0],"point_l1")
