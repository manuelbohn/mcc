...
// what happens between trials - display agent from previous trial and click on it to move on to the next trial  
 ...
 newtrial: function() {
    ...
    experiment.random = randomInteger(2);
...
if (experiment.agentOrient[0][0] == "point"){
        ...
        if (experiment.cond[0][2] == "left") {
                pause("next",2000); 
                sourceSound("sound/"+agents[0]+"_ppoint_weak.mp3");
                playSound();
                showAgent(agents[0],"point_l");
            if (experiment.cond[0][3] == "left") {
                    if (experiment.fruitPosition[0] == leftFruit[0]){
                        $("#fruit_l").animate({width: "200px",opacity: '0.6', queue: true},1000);
                        $("#fruit_l").animate({width: "130px",opacity: '1', queue: true},500);
                    } else {
                        $("#fruit_l2").animate({width: "200px",opacity: '0.6', queue: true},1000);
                        $("#fruit_l2").animate({width: "130px",opacity: '1', queue: true},500);
                    }; 
            } else {
                if (experiment.fruitPosition[0] == leftFruit[0]){
                        $("#fruit_l2").animate({width: "200px",opacity: '0.6', queue: true},1000);
              ...
              if (experiment.cond[0][3] == "right") {
                    if (experiment.fruitPosition[0] == rightFruit[0]){
                        $("#fruit_r").animate({width: "200px",opacity: '0.6', queue: true},1000);
                        $("#fruit_r").animate({width: "130px",opacity: '1', queue: true},500);
                        } else {
                        $("#fruit_r2").animate({width: "200px",opacity: '0.6', queue: true},1000);
                        $("#fruit_r2").animate({width: "130px",opacity: '1', queue: true},500);
                        }
               } else {
                   if (experiment.fruitPosition[0] == rightFruit[0]){
                        $("#fruit_r2").animate({width: "200px",opacity: '0.6', queue: true},1000);
