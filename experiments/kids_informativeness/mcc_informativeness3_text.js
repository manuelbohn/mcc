...
var trial = ["train1","train2","finTrain","filler1",1,2,3,"filler2",4,5,6]
...
// recording the choice 
  choice: function(event) {
    ...
    if (experiment.trial[0] == "train1" || experiment.trial[0] == "filler1"){
        ...
        } else if (experiment.trial[0] == "train2" || experiment.trial[0] == "filler2"){
  ...
  // after exposure is finished, switch to choice      
   ...
   /*if (experiment.agentOrient[0][0] == "straight") { 
    ...
    if (experiment.trial[0] == "train1"){
        ...
        showRightFruit2(); 
    } else  if (experiment.trial[0] == "filler1"){
       sourceLeftFruit("images/"+leftFruit[0]+".png");
        showLeftFruit(); 
        sourceLeftFruit2("images/empty.png");
        showLeftFruit2(); 
