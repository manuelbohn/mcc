...
var trainEmo = ["pos","pos"];
var testEmo = shuffle(["pos","pos","pos","pos","neg","neg","neg","neg"]);
var emo = trainEmo.concat(testEmo)
...
if (experiment.emo[0]=="neg"){     
  ...
  // commenting on objects on the tables depending on condition      
    if (experiment.agentOrient[0][0] == "point" && experiment.pref[0] == "left") { 
        ...
        pause("next",2000); 
        sourceSound("sound/"+agents[0]+"_npoint_weak.mp3");
        playSound();   
    } else if (experiment.agentOrient[0][0] == "point" && experiment.pref[0] == "right"){ 
        pause("next",2000); 
