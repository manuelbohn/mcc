...
ggplot(data = ex_3_pred, aes(x = alignment, y = mean, col = model)) +
  ...
  scale_color_manual(name="Model",
                     ...
                     values= c("black","#859900","#C5D86D","#86615C","#AFE0CE"))+
...
ggplot(ex3_model_comparison, aes(x = model, y = logP, col = model))+
  ...
  scale_color_manual(breaks=c("pragmatic","pragmatic_noise","prior_only_noise","flat_prior_noise"),
                    values= c("#00afaf","#C5D86D","#86615C","#AFE0CE"))
```
...
ggplot(data = ex_4_pred, aes(x = alignment, y = mean, col = model)) +
  ...
  scale_color_manual(name="Model",
                     ...
                     values= c("black","#C5D86D","#86615C","#AFE0CE"))+
  theme(axis.text.x=element_text(angle = 45, vjust = 1, hjust = 1))
...
# model predictions
child_ex3_pragm_model_predictions <- readRDS("../../stats/saves/child_ex3_pragm_model.rds") %>%
...
var resultsOutFile = "../../stats/data/llh_child_prag_param_free.csv"
var modelVariant = "integration parameter free"
...
# )
# 
# read_csv("../../stats/data/llh_child_prag_param_free.csv")%>%
#   mutate(model = "pragmatic",
...
child_ex3_pragm_model_likelihood_marginal <- child_ex3_pragm_model_likelihood%>%
  group_by(model,parameter)%>%
  summarise(logP = mean(weight),
            ci_lower = hdi_lower(weight),
            ci_upper = hdi_upper(weight))
...
var resultsOutFile = "../../stats/data/llh_child_prag_noise.csv"
var modelVariant = "integration noise"
 var fileHandle = webpplCsv.openFile(resultsOutFile)
 var header_to_write = ["modelVariant", "steps", "iter", "weight"].join(",")
 webpplCsv.writeLine(header_to_write,fileHandle)
 var weights = map(function(i) {
...
# )
# 
# read_csv("../../stats/data/llh_child_prag_noise.csv")%>%
#   mutate(model = "pragmatic",
#          parameter = "noise")%>%
...
child_ex3_pragm_model_noise_likelihood_marginal <- child_ex3_pragm_model_noise_likelihood%>%
  group_by(model,parameter)%>%
  summarise(logP = mean(weight),
            ci_lower = hdi_lower(weight),
            ci_upper = hdi_upper(weight))
...
var resultsOutFile = "../../stats/data/llh_child_prag_dev_noise.csv"
var modelVariant = "integration dev noise"
 var fileHandle = webpplCsv.openFile(resultsOutFile)
 var header_to_write = ["modelVariant", "steps", "iter", "weight"].join(",")
 webpplCsv.writeLine(header_to_write,fileHandle)
 var weights = map(function(i) {
...
# )
# 
# read_csv("../../stats/data/llh_child_prag_dev_noise.csv")%>%
#   mutate(model = "pragmatic",
...
child_ex3_pragm_model_developmental_noise_likelihood_marginal <- child_ex3_pragm_model_developmental_noise_likelihood%>%
  group_by(model,parameter)%>%
  summarise(logP = mean(weight),
            ci_lower = hdi_lower(weight),
            ci_upper = hdi_upper(weight))
...
var resultsOutFile = "../../stats/data/llh_child_flat_prior_param_free.csv"
var modelVariant = "flat prior parameter free"
 var fileHandle = webpplCsv.openFile(resultsOutFile)
 var header_to_write = ["modelVariant", "steps", "iter", "weight"].join(",")
 webpplCsv.writeLine(header_to_write,fileHandle)
 var weights = map(function(i) {
...
# )
# 
# read_csv("../../stats/data/llh_child_flat_prior_param_free.csv")%>%
#   mutate(model = "flat_prior",
#          parameter = "parameter free")%>%
...
child_ex3_flat_prior_model_likelihood_marginal <- child_ex3_flat_prior_model_likelihood%>%
  group_by(model,parameter)%>%
  summarise(logP = mean(weight),
            ci_lower = hdi_lower(weight),
            ci_upper = hdi_upper(weight))
...
var resultsOutFile = "../../stats/data/llh_child_flat_prior_noise.csv"
var modelVariant = "flat prior noise"
 var fileHandle = webpplCsv.openFile(resultsOutFile)
 var header_to_write = ["modelVariant", "steps", "iter", "weight"].join(",")
 webpplCsv.writeLine(header_to_write,fileHandle)
 var weights = map(function(i) {
...
# )
# 
# read_csv("../../stats/data/llh_child_flat_prior_noise.csv")%>%
#   mutate(model = "flat_prior",
#          parameter = "noise")%>%
...
child_ex3_flat_prior_model_noise_likelihood_marginal <- child_ex3_flat_prior_model_noise_likelihood%>%
  group_by(model,parameter)%>%
  summarise(logP = mean(weight),
            ci_lower = hdi_lower(weight),
            ci_upper = hdi_upper(weight))
...
var resultsOutFile = "../../stats/data/llh_child_flat_prior_dev_noise.csv"
var modelVariant = "flat prior dev noise"
 var fileHandle = webpplCsv.openFile(resultsOutFile)
 var header_to_write = ["modelVariant", "steps", "iter", "weight"].join(",")
 webpplCsv.writeLine(header_to_write,fileHandle)
 var weights = map(function(i) {
...
# )
# 
# read_csv("../../stats/data/llh_child_flat_prior_dev_noise.csv")%>%
#   mutate(model = "flat_prior",
#          parameter = "developmental noise")%>%
...
child_ex3_flat_prior_model_developmental_noise_likelihood_marginal <- child_ex3_flat_prior_model_developmental_noise_likelihood%>%
  group_by(model,parameter)%>%
  summarise(logP = mean(weight),
            ci_lower = hdi_lower(weight),
            ci_upper = hdi_upper(weight))
...
var resultsOutFile = "../../stats/data/llh_child_prior_only_param_free.csv"
var modelVariant = "prior only parameter free"
 var fileHandle = webpplCsv.openFile(resultsOutFile)
 var header_to_write = ["modelVariant", "steps", "iter", "weight"].join(",")
 webpplCsv.writeLine(header_to_write,fileHandle)
 var weights = map(function(i) {
...
```{r}
# webppl(
#   program_code = paste(rsaUtils, rsaModel, child.ex3.prior.only.marginal.likelihood, sep='\n'),
#   data =list(allData = ex3_model_data),
#   data_var = "dataFromR",
#   packages ="webppl-csv",
#   chains = 1,
...
# )
# 
# read_csv("../../stats/data/llh_child_prior_only_param_free.csv")%>%
#   mutate(model = "prior_only",
#          parameter = "parameter free")%>%
...
child_ex3_prior_only_model_likelihood_marginal <- child_ex3_prior_only_model_likelihood%>%
  group_by(model,parameter)%>%
  summarise(logP = mean(weight),
            ci_lower = hdi_lower(weight),
            ci_upper = hdi_upper(weight))
...
var resultsOutFile = "../../stats/data/llh_child_prior_only_noise.csv"
var modelVariant = "prior only noise"
 var fileHandle = webpplCsv.openFile(resultsOutFile)
 var header_to_write = ["modelVariant", "steps", "iter", "weight"].join(",")
 webpplCsv.writeLine(header_to_write,fileHandle)
 var weights = map(function(i) {
...
# )
# 
# read_csv("../../stats/data/llh_child_prior_only_noise.csv")%>%
#   mutate(model = "prior_only",
#          parameter = "noise")%>%
...
child_ex3_prior_only_model_noise_likelihood_marginal <- child_ex3_prior_only_model_noise_likelihood%>%
  group_by(model,parameter)%>%
  summarise(logP = mean(weight),
            ci_lower = hdi_lower(weight),
            ci_upper = hdi_upper(weight))
...
var resultsOutFile = "../../stats/data/llh_child_prior_only_dev_noise.csv"
var modelVariant = "prior only developmental noise"
 var fileHandle = webpplCsv.openFile(resultsOutFile)
 var header_to_write = ["modelVariant", "steps", "iter", "weight"].join(",")
 webpplCsv.writeLine(header_to_write,fileHandle)
 var weights = map(function(i) {
...
# )
# 
# read_csv("../../stats/data/llh_child_prior_only_dev_noise.csv")%>%
#   mutate(model = "prior_only",
#          parameter = "developmental noise")%>%
...
child_ex3_prior_only_model_developmental_noise_likelihood_marginal <- child_ex3_prior_only_model_developmental_noise_likelihood%>%
  group_by(model,parameter)%>%
  summarise(logP = mean(weight),
            ci_lower = hdi_lower(weight),
            ci_upper = hdi_upper(weight))
...
# combining model log-likelihoods

# child_ex3_model_comparison <- bind_rows(
#   child_ex3_pragm_model_likelihood_marginal,
#   child_ex3_pragm_model_noise_likelihood_marginal,
#   child_ex3_pragm_model_developmental_noise_likelihood_marginal,
#   child_ex3_flat_prior_model_noise_likelihood_marginal,
#   child_ex3_flat_prior_model_likelihood_marginal,
#   child_ex3_flat_prior_model_developmental_noise_likelihood_marginal,
#   child_ex3_prior_only_model_noise_likelihood_marginal,
#   child_ex3_prior_only_model_likelihood_marginal,
#   child_ex3_prior_only_model_developmental_noise_likelihood_marginal
# )%>%
#   ungroup()%>%
#   mutate(model = reorder(model,logP))%>%
...
ggplot(child_ex3_model_comparison, aes(x = model, y = logP, col = model))+
  ...
  geom_point(size = 7)+
  #geom_pointrange(aes(x = model, y = logP, ymin = ci_lower, ymax = ci_upper ), pch = 4)+
  theme_few()+ 
  xlab("Model")+
  ylab("Log-likelihood")+
  theme(axis.text.x=element_text(angle = 45, vjust = 1, hjust = 1))+
...
```
#### Likelihood distributions (noise models only)

```{r}
# child_ex3_model_ll_dist <- bind_rows(
...
# )%>%
#   ungroup()%>%
#   mutate(model = reorder(model,weight))%>%
#   saveRDS("../../stats/saves/child_ex3_model_comparison_dist.rds")

child_ex3_model_ll_dist <- readRDS("../../stats/saves/child_ex3_model_comparison_dist.rds")

ggplot(child_ex3_model_ll_dist, aes(x = weight, col = model, fill = model))+
