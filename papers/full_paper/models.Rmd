...
```{r loglike rsa noise ex3, include = FALSE}
...
```{r loglike prior only noise ex3, include = FALSE}
...
```{r loglike flat prior noise ex3, include = FALSE}
...
##### Pragmatic model 
```{r loglike rsa noise ex4, include = FALSE}
...
```{r loglike prior only noise ex4, include = FALSE}
...
```{r loglike flat prior noise ex4, include = FALSE}
