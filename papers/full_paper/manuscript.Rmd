...
We thank Jacqueline Quirke and Sabina Zacco for help with the data collection and Bria Long and Gregor Kachel for comments on an earlier version of the paper. M. Bohn received funding from the European Union’s Horizon 2020 research and innovation programme under the Marie Sklodowska-Curie grant agreement no. 749229. M. C. Frank was supported by a Jacobs Foundation Advanced Research Fellowship and the Zhou Fund for Language and Cognition. All experiments and analyses were pre-registered (https://osf.io/u7kxe/). Stimuli, data, and analysis code are available in a public repository (https://github.com/manuelbohn/mcc).
