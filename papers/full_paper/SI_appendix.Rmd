...
because the speaker is pointing to the table with $r_2$ and $r_3$, and under $\mathcal{L}_1$, "dax" means the red object and under $\mathcal{L}_2$, "dax" means the yellow object.
After normalization we have:

$$
\begin{aligned}
& P_{L_0}(r_1^r, \mathcal{L}_1 | {u_3}) = 0 \\
& P_{L_0}(r_2^r, \mathcal{L}_1 | {u_3}) = 0.13 \\
& P_{L_0}(r_3^y, \mathcal{L}_1 | {u_3})   = 0 \\
& P_{L_0}(r_1^r, \mathcal{L}_2 | {u_3})   = 0 \\
& P_{L_0}(r_2^r, \mathcal{L}_2 | {u_3})   = 0 \\
& P_{L_0}(r_3^y, \mathcal{L}_2 | {u_3}) = 0.24\\
\end{aligned}
$$
...
&P_{L_0}(r_2|u_3) =  P_{L_0}(r_2, \mathcal{L}_1|u_3) + P_{L_0}(r_2, \mathcal{L}_2|u_3) = 0.13+0=0.13 \\
&P_{L_0}(r_3|u_3) =  P_{L_0}(r_3, \mathcal{L}_1|u_3) + P_{L_0}(r_3, \mathcal{L}_2|u_3) = 0+0.24=0.24 \\
\end{aligned}
$$
