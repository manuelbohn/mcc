...
As spelled out in @goodman2013knowledge, the informativity of an utterance for a referent is the (log) probability that a naive listener $L_0$ would select that referent given that utterance.
