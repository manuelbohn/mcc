...
\end{cases}
$$
To arrive at the production probabilities, you the values from the previous calculation so that they add to 1:
...
Finally, based on equation 1 we can use these values to compute the probability that the listener thinks that the speaker is referring to the yellow type ($r_y$) when they produce $u_3$ (pointing to the right table and saying "dax"). In this case, it is the same as the probability of the yellow referent ($r_{y2}$) because there is only one yellow object.
...
$$
\begin{aligned}
& P_{L_1}(r_{p1}, \mathcal{L}_1 | {u_3})  \propto P_{S_1}(u_3 \mid r_{p1}, \mathcal{L}_1) P(r_{r1}) P(\mathcal{L}_1) = 0.09 \times 0.26 \times 0.5 =0.012\\
& P_{L_1}(r_{p2}, \mathcal{L}_1 | {u_3})  \propto P_{S_1}(u_3 \mid r_{p2}, \mathcal{L}_1)  P(r_{r2}) P(\mathcal{L}_1) = 0.09 \times 0.26 \times 0.5 =0.012\\
& P_{L_1}(r_{y2}, \mathcal{L}_1 | {u_3})  \propto P_{S_1}(u_3 \mid r_{y2}, \mathcal{L}_1)  P(r_{y2}) P(\mathcal{L}_1) = 0 \times 0.48 \times 0.5 =0\\
& P_{L_1}(r_{p1}, \mathcal{L}_2 | {u_3})  \propto P_{S_1}(u_3 \mid r_{p1}, \mathcal{L}_2)  P(r_{r1}) P(\mathcal{L}_2) = 0 \times 0.26 \times 0.5=0\\
& P_{L_1}(r_{p2}, \mathcal{L}_2 | {u_3})  \propto P_{S_1}(u_3 \mid r_{p2}, \mathcal{L}_2) P(r_{r2}) P(\mathcal{L}_2) = 0 \times 0.26 \times 0.5=0\\
