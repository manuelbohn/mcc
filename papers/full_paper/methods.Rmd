...
#          id = subid)%>%
#   filter(trial != "train")%>%
#   select(experiment,id,age_bin,age_num,trial,condition,agent,correct)
# 
...
#          id =subid)%>%
#   select(experiment,id,age_bin,age_num,trial,correct)
# 
...
#   select(experiment, id,age_bin,age_num,trial, speaker, alignment, agent, correct_inf)
#  
